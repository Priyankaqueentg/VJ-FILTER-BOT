...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002497597012'))
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1740849725').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002316804550').split()]
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002238905048') # give your force subscribe channel id here else leave it blank
...
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'shotyfi.link')
